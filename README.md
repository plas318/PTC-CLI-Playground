...
if($debug -eq 1){
	...
	--field="Document Short Title"=$documentShortTitle `
	--field="Shared Text"=$sharedText `
	--addRelationships="Changes Authorized By"=$issueId
...
---
```
=CONCATENATE("im createcontent -project ",  CHAR(34),$F$35,CHAR(34), " -documentType ", CHAR(34), $F$32, CHAR(34), " -sharedText ",  CHAR(34), $G$35,CHAR(34), " -documentShortTitle ", CHAR(34), $G$32,CHAR(34), " -assignees ",CHAR(34),$C$32,CHAR(34),IF(NOT(COUNTBLANK($D$32)), CONCATENATE(", ", CHAR(34), $D$32, CHAR(34)),""), IF(NOT(COUNTBLANK($E$32)), CONCATENATE(", ", CHAR(34), $E$32, CHAR(34)),""), IF(NOT(COUNTBLANK($C$35)), CONCATENATE(" -members ", CHAR(34), $C$35, CHAR(34)),""), IF(NOT(COUNTBLANK($D$35)), CONCATENATE(", ", CHAR(34), $D$35, CHAR(34)),""), IF(NOT(COUNTBLANK($E$35)), CONCATENATE(", ", CHAR(34), $E$35, CHAR(34)),""), " --addRelationships=", CHAR(34),"Changes Authorized By", CHAR(34), "=$issueId", ";")
```
...
#### EXCEL Ver
```
=CONCATENATE("Standby -targetId ",$B$7," -state ", CHAR(34), $C$10,CHAR(34)," -comments ",$B$20," -assignees ",CHAR(34),$B$14,CHAR(34),IF(NOT(COUNTBLANK($C$14)), CONCATENATE(", ", CHAR(34), $C$14, CHAR(34)),""), IF(NOT(COUNTBLANK($D$14)), CONCATENATE(", ", CHAR(34), $D$14, CHAR(34)),""), IF(NOT(COUNTBLANK($F$14)), CONCATENATE(" -confirmers ", CHAR(34), $F$14, CHAR(34)),""), IF(NOT(COUNTBLANK($G$14)), CONCATENATE(", ", CHAR(34), $G$14, CHAR(34)),""), IF(NOT(COUNTBLANK($H$14)), CONCATENATE(", ", CHAR(34), $H$14, CHAR(34)),""), CONCATENATE(" -ctype ", $E$14), ";")
```
